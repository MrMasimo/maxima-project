<?php
/**
 * Класс для работы с моделями - ActiveRecord
 */
...
abstract class Model
{
    ...
    public static function filter($field, $value): array
    {
        $sql = 'SELECT * FROM ' . static::getTableName() . ' WHERE '. $field . '=' . $value .' ORDER BY id';
        return static::query($sql);
    }
